...
<head>
	...
	<c:if test="${not empty button_disabled_express }">
	
    function disable_express(){
    	alert("未发货，不能查看物流。");
    }
...
<div class="mobile">
    ...
    <div class="view w">
		...
		<c:if test="${not empty button_pay_order }">
		...
		${button_disabled_express }
		
		</c:if>
		
		<c:if test="${not empty button_comment }">
		
		${button_comment }
		
		</c:if>
		
		<c:if test="${not empty btn_recieve_order }">
		
		${btn_recieve_order }
		
		</c:if>
		
		<c:if test="${not empty button_disabled_comment }">
		
		${button_disabled_comment }
		
		</c:if>
		
		<c:if test="${not empty button_check_express }">
		
		${button_check_express }
