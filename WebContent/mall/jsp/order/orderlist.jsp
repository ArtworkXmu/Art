...
<div class="mobile">
    ...
    <header>
        <div class="header">
         <a class="new-a-back" href="/Art/mall/jsp/order/order.jsp"> <span><img src="/Art/mall/images/iconfont-fanhui.png"></span> </a>
    ...
    <div  class="order_list w">
        ...
        <ul style="height: auto">
			...
			<li>
                <a href="/Art/mall/jsp/order/orderdetail?id=${order.id}">
